    ...
    <>
      <AnimatePresence>
        {isOpen && (
          ...
          <button
            onClick={handleClose}
            className="absolute top-3.5 right-3.5 p-2 rounded-full text-slate-400 hover:text-white bg-slate-800/90 hover:bg-slate-700 transition-colors z-20 cursor-pointer shadow-md"
          ...
          {/* Certificate Documents Grid (2 A4 Previews) */}
